...
@WebServlet("/adminSelectAllUser")
public class AdminSelAllUser extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        try {
            ...
            List<User> list = userService.adminSelectAllUser(currentPage,pageSize);
            resultMap.setList(list);
            Long total=userService.adminSelectCountUser();
